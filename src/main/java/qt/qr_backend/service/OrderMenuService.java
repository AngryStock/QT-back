...
public class OrderMenuService {
    ...
    public OrderMenuDTO saveOrderMenu(OrderMenuDTO orderMenuDTO){
        OrderMenu orderMenu = orderMenuRepository.save(orderMenuDTO.toOrderMenu(orderRepository,menuRepository));
    ...
    public List<OrderMenuDTO> saveAllOrderMenu(List<OrderMenuRequest> orderMenuRequestList, String tableId, String orderId, String storeId){
        ...
        Order savedOrder = orderRepository.save(new Order(orderId, storeRepository.getReferenceById(storeId), LocalDateTime.now(), "WAIT", tableId,orderPrice ));
        ...
        List<OrderMenuDTO> orderMenuDTOS = OrderMenuDTO.listFromOrderMenutoOrderMenuDTO(orderMenuRepository.saveAll(orderMenuDTOList.stream().map(l -> new OrderMenu(null,orderRepository.getReferenceById(savedOrder.getId()),menuRepository.getReferenceById(l.getMenuId()),l.getOrderMenuPrice())).toList()));
